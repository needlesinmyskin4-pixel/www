...
print(db.stats())  # {'users': 1, 'games': 0, 'sessions': 1, ...}`,
  },
  {
    ...
    icon: Database,
    install: "pip install rogiant[postgres]",
    highlights: [
...
for row in top:
  ...
  },
  {
    ...
    icon: Database,
    install: "pip install rogiant[mysql]",
    highlights: [
...
print(db.get("config.region"))  # us-east`,
  },
  {
    ...
    icon: Boxes,
    install: "pip install rogiant[mongo]",
    highlights: [
...
for doc in recent:
  ...
  },
  {
    ...
    icon: Zap,
    install: "pip install rogiant[redis]",
    highlights: [
...
print(cache.get("queue:trades"))`,
  },
  {
    ...
    icon: Cloud,
    install: "pip install rogiant[supabase]",
    highlights: [
